...
import { MessageSquare, Clock, CheckCircle, XCircle, AlertCircle, Calendar, User } from 'lucide-react';
...
const RAGQualityImprovementRequestList: React.FC = () => {
  ...
  return (
    <div className="app">
      ...
      />
      <main className="app-main">
        <div className="improvement-request-list-container" style={{ maxWidth: '65vw', margin: '0 auto' }}>
...
export default RAGQualityImprovementRequestList;
